 ...
 * @param pos the supplied position
 * @return the count of credits/cast
 */
    
  short getCount(int& payload, const char* pos) const;
 ...
 * player.
 *
 * @param offset the supplied offset
 * @param player the supplied player for comparison
 * @return true if the actor name at the provided offset is lexicographically less
 * than the supplied player.
 */
 ...
 *
 * @param offset the supplied offset
 * @param movie the supplied movie for comparison
 * @return true if the movie name at the provided offset is lexicographically less
 * than the supplied movie.
 */
    
  bool compareMovieAtOffset(int offset, const film& movie) const;  
